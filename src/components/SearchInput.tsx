...
export default function SearchInput() {
  return (
    <div className="flex flex-row w-full justify-center">
      ...
      <button
        name="submit"
        className="flex items-center py-2 px-4 bg-red-700 text-gray-100 transition duration-300 ease-in-out hover:outline-none focus:ring-1 hover:ring-gray-100 hover:bg-red-600 hover:text-gray-900 rounded-l-none rounded-r-full"
      >
